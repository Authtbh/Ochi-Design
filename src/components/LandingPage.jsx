            ...
            <div className='w-full bg-zinc-100'>
                    ...
                    {["We Create", "Eye-Opening", "Presentations"].map((item, index) => {
                        ...
                        return (
                            <div key={index} className='flex gap-2'>
                                {index === 1 && <img className=' w-[9.5vw] h-[6vw] mt-4 rounded-md overflow-hidden'
                                    src={TitleImg} alt="titleImage" />}
                ...
                <div className='flex justify-between items-center px-12 py-4'>
                    ...
                    items-center gap-1'>
                        ...
                        <button className=' px-4 py-1 border-[1px] text-sm font-[NeueMontreal-Regular]
